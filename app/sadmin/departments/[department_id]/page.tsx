...
export default function AdminStudentView({ params }: { params: { department_id: string } }) {
  ...
  async function deleteStudent() {
    ...
    await request(`${process.env.NEXT_PUBLIC_BACKEND_IP}/superadmin/department/${params.department_id}/${currentStudent._id}`, {method: 'DELETE', cache: 'no-cache', headers: {'Authorization': `Bearer ${cookie.token}`, 'Content-Type': 'application/json', 'Accept': 'application/json'}})
  ...
  useEffect(() => {
    const fetchDatas = async () => {
      try {
        const response = await request(`${process.env.NEXT_PUBLIC_BACKEND_IP}/superadmin/department/${params.department_id}`, {method: 'GET', cache: 'no-cache', headers: {'Authorization': `Bearer ${cookie.token}`, 'Content-Type': 'application/json', 'Accept': 'application/json'}})
    ...
    <div className={styles.admin_main_contents}>
      <div className={[styles.coloredButton, styles.light_gray_div].join(' ')}>
        <div className={styles.light_gray_heading_div}>
          ...
          <Link href={`/sadmin/departments/${params.department_id}/add`} className={[styles.iconButton_div, roboto.className].join(' ')}>
